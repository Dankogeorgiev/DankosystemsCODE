...
function applyAccess() {
  const adminOnly = document.querySelectorAll(
    '#btn-new,#btn-new-order,#btn-new-claim,#btn-report,#btn-claim-report,#btn-main-messages,#btn-contacts,#btn-painting,#btn-painting-manual,#btn-export,label[for="import-file"]');
