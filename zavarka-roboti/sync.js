/* Данко Системс — Споделяне на „Заваръчно — роботи“
   Същата Supabase сесия като основното приложение. Държи състоянието на
   роботизираното заваряване като ред 'welding_roboti_line' в таблица
   app_config и го споделя на живо. Дневните отчети влизат в общия списък
   'painting_reports' (общият изглед „Времена“), с маркер cex:'Заваръчно
   роботи', за да се различават от другите цехове.
...
(function () {
  ...
  const KEY = "welding_roboti_line";
  const CEX = "Заваръчно роботи";
  ...
  function subscribe() {
    sbx.channel("welding-roboti-line")
  ...
  // Маркира го с cex:'Заваръчно роботи', за да се отличи от другите цехове.
