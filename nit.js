...
const NIT_ACCESSORY_MAT_CODES = new Set(["100128", "100194", "100109"]);          // материали: болт DIN 912 M8x60, степенчато колело, амортисьор 1000 N (Шикозен)
...
const NIT_ACCESSORY_WATCH_CODES = new Set(["100540"]);   // продукти: ос пружина
