...
const NIT_PICK_RULES = {
  "Италия затваряне на крак": {
    // (празно за момента — връзваме масово, щом дойдат рецептите на всички
    // механизми. ОБРАЗЕЦЪТ, проверен с ASIA на 28.07.2026:
    // "101007": { consume: [
    //   { code: "100971", per: 1 },              // крак десен
    //   { code: "100950", per: 1 },              // заготовка ЛЯВА (страните са кръстосани по рецепта)
    //   { code: "100175", per: 2, mat: true },   // Нит 8 х 26
    //   { code: "100188", per: 2, mat: true },   // Подложна шайба DIN 125 АМ 8
    // ] },
    // "101008": { consume: [ крак 100972 + заготовка 100949 + същите материали ] },
    // + ред в NIT_COMBINE: 101007 + 101008 → 101137 с extra спирачки/болтове/колела.)
  },
};
