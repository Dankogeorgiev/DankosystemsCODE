/* Данко Системс — Споделяне на „Ръчно заваръчно“
   ...
   и го споделя на живо между таблетите. Дневните отчети (по желание) влизат
   в общия списък 'painting_reports' (изгледа „Времена“), с маркер
   cex:'Ръчно заваръчно'.
   ...
   Задачите от Цех „Заваръчно“ страницата чете сама (собствен клиент). */
