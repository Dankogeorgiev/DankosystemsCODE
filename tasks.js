...
function flowTaskCloseDialog(t) {
  ...
  const { wrap, close } = erpDialog(`
    ...
    <p class="hint" style="margin:0 0 8px">
      <b>1. Спиране на цялата заявка</b> — ЕРП → Заявки → „↩ Изтегли от производство". Маха всички задачи наведнъж и освобождава резервираната наличност; готовото (заприходеното) остава в склада, анулира се само недовършената работа.<br>
...
async function toggleTimes() {
  ...
  if (typeof renderTimesReport === "function") renderTimesReport(null); else renderTimes();
}
