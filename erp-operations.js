...
const ERP_ROUTING_SEED = [
  ...
  { kw: ["малък бял", "италия", "45 градус", "потащящ", "зачистване от боя"], primary: "ЦЕХ РОГОШ" },
  { kw: ["лентоотрез", "лентоорез", "разкрой тръб"], primary: "РАЗКРОЙ ТРЪБИ" },
  { kw: ["зачистван"],   primary: "Заготовки" },
  ...
  // Щанцоването се реже на лазерите (искане на Данко, 30.07.2026) — Преси остава алтернатива.
  { kw: ["щанц"],        primary: "Лазери", alt: ["Преси"] },
  { kw: ["резбов", "набиване", "оребр", "пробиван", "сечене", "гилотина", "преса"], primary: "Преси" },
];
